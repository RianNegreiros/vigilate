...
export default function AccountPage() {
  ...
  return (
    <>
      ...
      <div className="p-4">
        <div className="p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-lg hover:border-gray-300">
          <div className="mb-4">
          ...
          <div className="py-4">
            <p className="text-sm font-semibold text-gray-900 dark:text-white">Notifications Settings</p>
            <ul role="list" className="divide-y mt-4 divide-gray-100 rounded-md border border-gray-200">
              <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                ...
                <div className="ml-4 flex-shrink-0">
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" value="" className="sr-only peer" checked={userData.notification_preferences.email_enabled} onChange={handleEmailChange} />
